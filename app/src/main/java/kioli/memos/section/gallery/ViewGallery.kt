...
import kioli.memos.section.gallery.async.GetDirectoriesAsynctask
import kioli.memos.section.gallery.async.GetMediaAsynctask
...
class ViewGallery : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        list_photos.layoutManager = StaggeredGridLayoutManager(3, 1)
